...
def get_num_poor_agents(model):
    ...
    poor_agents = [a for a in model.schedule.agents if a.loans > 20] # valor alterado para 20, antes era 10
...
def get_num_mid_agents(model):
    ...
    mid_agents = [
        ...
        if a.loans < 20 and a.savings < model.rich_threshold # valor alterado para 20, antes era 10
    ]
